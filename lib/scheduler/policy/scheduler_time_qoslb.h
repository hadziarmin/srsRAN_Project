 ...
 */
 ...
 /// Time-domain QoS-aware location based scheduler policy.
 class scheduler_time_qos_lb final : public scheduler_policy
 {
 public:
   scheduler_time_qos_lb(const scheduler_ue_expert_config& expert_cfg_, du_cell_index_t cell_index);
 ...
 private:
   ...
   struct ue_ctxt {
     ue_ctxt(du_ue_index_t ue_index_, du_cell_index_t cell_index_, const scheduler_time_qos_lb* parent_);
     ...
     const du_cell_index_t     cell_index;
     const scheduler_time_qos_lb* parent;
